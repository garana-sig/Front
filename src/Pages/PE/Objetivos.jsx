...
import Mobjetivos from './Mapa_objetivos.pdf';

function Objetivos() {
  const [isLoading, setIsLoading] = useState(true);
  const [error, setError] = useState(false);
  
  const pdfUrl = Mobjetivos;
  ...
  return (
    <div className='max-w-4xl mx-auto px-4 py-6'>
      <div className="flex justify-between items-center mb-6">
        <h1 className="text-3xl font-bold text-gray-800">Mapa de Objetivos Garana</h1>
        
        {/* Botón de descarga mejorado */}
        <a 
          href={pdfUrl} 
          download="Mapa de Objetivos.pdf"
